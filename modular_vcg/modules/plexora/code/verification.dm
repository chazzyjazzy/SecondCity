...
/datum/asset/simple/discord_verification
	assets = list(
		"dverify_image1.png" = 'modular_vcg/modules/plexora/icons/tgui/dverify_image1.png',
		"dverify_image2.png" = 'modular_vcg/modules/plexora/icons/tgui/dverify_image2.png',
		"dverify_image3.png" = 'modular_vcg/modules/plexora/icons/tgui/dverify_image3.png',
		"dverify_image4.png" = 'modular_vcg/modules/plexora/icons/tgui/dverify_image4.png',
	)
