 ...
 */
/obj/machinery/vending/proc/proceed_payment(obj/item/card/credit/paying_creditcard, mob/living/mob_paying, datum/data/vending_product/product_to_vend, price_to_use, premium)
	PROTECTED_PROC(TRUE)
