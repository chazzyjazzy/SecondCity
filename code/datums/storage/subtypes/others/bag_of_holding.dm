...
/datum/storage/bag_of_holding/attempt_insert(obj/item/to_insert, mob/user, override, force, messages, list/modifiers) // DARKPACK EDIT CHANGE - Original: /datum/storage/bag_of_holding/attempt_insert(obj/item/to_insert, mob/user, override, force, messages)
